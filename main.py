# this is the script that will fetch google classroom available courses
import os.path
import sys
...
origins = [
    ...
    "http://localhost:8000", # The FastAPI server itself
    "http://127.0.0.1:8000", # Alias for localhost
    "http://localhost:5500", # VS Code Live Server
    "http://127.0.0.1:5500", # VS Code Live Server (your current origin)
    "null",  # Important for 'file://' protocol when opening index.html directly
]
...
if __name__ == "__main__":
    # Using "main:app" string enables reload and is standard for uvicorn
    # reload=True will automatically restart the server on code changes
